...
sig,fields=wfdb.rdsamp('rec_1',channels=[0], sampfrom=startSamp, sampto=endSamp)
sig2=sig.flatten()
fs=fields.get('fs')
...
cleanSig,field=wfdb.rdsamp('rec_1',channels=[1],sampfrom=startSamp, sampto=endSamp)
